# src/data/coco/coco_dataset_compat.py
"""
COCO dataset with compatibility for older torchvision versions
"""
...
class CocoDetection(torchvision.datasets.CocoDetection):
    ...
    def __getitem__(self, idx):
        ...
        # Handle datapoints compatibility
        if HAS_DATAPOINTS and 'boxes' in target:
        ...
        if HAS_DATAPOINTS and 'masks' in target:
...
# Import the label mappings from original
